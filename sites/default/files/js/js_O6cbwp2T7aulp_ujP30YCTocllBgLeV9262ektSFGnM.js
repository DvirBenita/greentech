...
/**
 * @file
 * Behaviors and functionality for the Webform Over Image block.
 */

((Drupal) => {
  /**
   * Client-side functionality for Webform Over Image blocks.
   *
   * @type {Drupal~behavior}
   *
   * @prop {Drupal~behaviorAttach} attach
   *  Attaches the gtWebformOverImage behavior.
   */
  Drupal.behaviors.gtWebformOverImage = {
    attach() {
      // Look for the presence of webform confirmations in our blocks on
      // this page.
      const confirmations = document.querySelectorAll(
        ".webform-over-image.block .webform-confirmation"
      );
      if (confirmations) {
        confirmations.forEach((confirmation) => {
          confirmation
            .closest(".webform-over-image.block")
